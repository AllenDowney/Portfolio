...
articles about their projects that could appear as guest articles on my
...
Spring 2016 while I was on sabbatical.
[Class web page](https://sites.google.com/site/datascience15/)

In each of these projects, I involve students by recruiting them to work
...
In October 2012 I presented a webcast with O’Reilly Media called
*Bayesian Statistics Made Simple*
[Webcast](http://www.oreilly.com/pub/e/2392)

In September 2015 I shot a 3.5 hour video series called *Data
...
special interest groups in the Boston area.
...
called Complexity Science, with Jason Woodard; and I will revise
...
more substantial revision than I planned. It was published in 2015.
...
In Fall 2015, I addressed the second problem by deploying EduScrum, a
structure for student learning based on the Scrum methodology for
software development. I thought both elements – *Think OS*
and EduScrum – worked well, and I am considering using EduScrum for some
...
become one of our tools for onboarding new professors.
...
with Siddhartan Govindasamy and Oscar Mur-Miranda. Our first attempt at
a major revision had some rough edges, but I thought the quality of the
final projects was evidence of the effectiveness of the approach.
...
14 articles there, including one guest post from a student team in
Software Systems.
...
between Software Systems and Architecture, and to ensure that we have
...
In Summer 2011 I visited KTH in Stockholm to meet with instructors who
...
In Summer 2015 I visited Insper in Brazil to collaborate with their
...
In 2014-15 I was executive chair of ARB again. I was also a member of
...
using software and processes developed with Mark Chang.
